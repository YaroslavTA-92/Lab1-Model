...
namespace SampleModel
{
    public class Tank
    {
        ...
        private LimitBlock xLimit = new LimitBlock(0, 0.3);
        private double dt = 0.1;
        public Tank(double dt) {
            this.dt = dt;
            kx1 = new GainBlock(0.0006);
            kx2 = new GainBlock(0.0006);
            
            Block = new ComplexBlock();
            Block.Add(new LimitedIntBlock(dt,0,0.00126));
        }
        ...
        //    return Block.Calc(x);
        //}
        public double Calc( double x2)
        {
            x2 = xLimit.Calc(x2);
            return Block.Calc(x2);
        }
    }
}
